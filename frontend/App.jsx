          ...
          <section className="rounded-2xl border border-slate-800 bg-slate-900 p-6 lg:col-span-1">
            ...
            <div className="mt-6 space-y-4">
              <div>
                ...
                <textarea
                  className="min-h-[180px] w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 text-sm text-white outline-none transition focus:border-slate-500"
